                ...
                switch (command)
                {
                    ...
                    case "remove": // deal with the remove command
                        ...
                        } else
                        {
                            ...
                            {
                                System.out
                                        .println("Rectangle rejected " + name);
                            }
                        }
                        break;
                    ...
                    case "regionsearch": // deal with the regionsearch command
                        ...
                        w = sc.nextInt();
                        h = sc.nextInt();
                        BstNode<String, Rectangle> currNodeRegion = tree
                                .getFirst(); // current node for regionsearch
                        System.out.println(
                                "Rectanagles intersecting region  " + "(" + x
                                        + "," + +y + "," + w + "," + h + "):");
                        while (currNodeRegion != null)
                        {
                            // search through the whole tree to see if there are
                            // any Rectangles in the region
                            if (currNodeRegion.element().isContained(x, y, w,
                                    h))
                            {
                                ...
                                System.out.println(
                                        currNodeRegion.element().toString()
                                                + "\n");
                    ...
                    case "intersections": // deal with the intersections command
                        ...
                        if (storedNode == null)
                            continue;
                        BstNode<String, Rectangle> interNode = tree
                                .getNext(storedNode);
                        for (int i = 0; i < tree.size() - 1; i++)
                        {
                            while (interNode != null)
                            {
                                ...
                                if (interNode.element()
                                        .intersects(storedNode.element()))
                                {
                                    System.out.print(interNode.element()
                                            .toString() + " : "
